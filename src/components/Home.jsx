...
function Home() {
  ...
  const shapes = Array(15)
    ...
    .map((_, i) => {
      ...
      const colors = ['#EF4444', '#F59E0B', '#10B981', '#3B82F6']; // Hex codes for colors
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 relative overflow-hidden pt-1">
      ...
      {shapes.map((shape) => (
        ...
        >
          <shape.ShapeComponent
            ...
            style={{ color: shape.color }} // ✅ FIX: Apply color inline
          />
        </div>
      ))}
      ...
      <div className="container mx-auto px-4 py-20 flex flex-col items-center justify-center min-h-screen relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8">I'm a Software Engineer</p>
        ...
        <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 text-center">
          ...
          <div className="w-6 h-10 border-2 border-gray-300 rounded-full mx-auto relative overflow-hidden">
